...
<text x="82" y="125" font-size="26" letter-spacing="5" fill="#e8ad35">THREE WORD GAMES</text>
...
<path d="M82 790H1178" stroke="#527393" stroke-width="2"/>
<text x="82" y="856" font-size="28" fill="#fff8e8">English · Romanized Punjabi · Gurmukhi</text>
<text x="82" y="925" font-size="23" letter-spacing="2" fill="#e8ad35">BUJHO  /  KHOJ  /  WORD QUEST</text>
</g></svg>`;
...
async function main() {
  ...
  console.log('Created original branding sources, web icons and itch.io cover.');
}
