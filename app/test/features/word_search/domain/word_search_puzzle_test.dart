...
void main() {
  ...
  test(
    'generator treats a Gurmukhi grapheme cluster as one visible letter',
    () {
  ...
  test('finds every grid cell matching a hint grapheme', () {
    ...
    expect(puzzle.cellsWithGrapheme('a'), {
      const GridPoint(0, 0),
      const GridPoint(0, 2),
      const GridPoint(1, 1),
    });
    expect(puzzle.words.single.firstGrapheme, 'B');
  });
}
