...
- Begin with unlimited random Guess the Word games.
- Add Word Search, Hangman or a themed equivalent, and a typing challenge later.

## Language modes

- English uses Latin script.
- Romanized Panjabi uses Latin script.
- English and romanized Panjabi share one on-screen Latin keyboard.
- Mixed Latin selects English or romanized Panjabi solutions and accepts valid guesses from both pools.
